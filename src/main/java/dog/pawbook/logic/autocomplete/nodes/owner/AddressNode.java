 ...
 */
public class AddressNode extends AutoCompleteNode<List<Owner>> {

    public AddressNode(List<Owner> pointer) {
        super(pointer);
    }
    ...
    public SortedSet<String> getValues() {
        ...
        pointer.forEach(owner -> values.add(owner.getAddress().toString()));
        return values;
    }
